...
namespace PlateStacker
{
    public class Controller
    {
        ...
        private List<Plate> CheckSet(List<Plate> plates)
        {
        ...
        private int CalcLengthPlate(List<Plate> plates)
        {
            int sumL = 0;
        ...
        public void PlatesHandler(List<Track> sortTracks, List<Track> finishTracks)
        {
            Track tempTrack;
            ...
            foreach (Track t in sortTracks)
            {
                ...
                tempTrack = new Track(t.TypeNode, lengthTrack);
